...
function getEmptyTodo(txt = '', importance = 5, bgColor = '#99A695') {
    return { txt, importance, isDone: false, bgColor }
}

function getDefaultFilter() {
    return { txt: '', importance: 0, type: 'all' }
}
